                            ...
                            <form method="POST" action="{{url('item/update')}}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3 {{ ($errors->has('item_name')) ? 'has-error' : ''}}">
                                        ...
                                        <input type="text" class="form-control" name="item_name" value="{{old('item_name', $item->name)}}" placeholder="Item Name" required>
                                    ...
                                    <div class="col-12 mb-3 {{ ($errors->has('price')) ? 'has-error' : ''}}">
                                        <input type="number" class="form-control" name="price" placeholder="Price" value="{{old('price', $item->price)}}" required>
                                        @if ($errors->has('price'))
                                    ...
                                    <div class="col-12 mb-3 {{ ($errors->has('manufacturer')) ? 'has-error' : ''}}">
                                        <input type="text" class="form-control" name="manufacturer" placeholder="Manufacturer" value="{{old('manufacturer', $item->manufacturer->name)}}" required>
                                    ...
                                    <div class="col-12 mb-3 {{ ($errors->has('url')) ? 'has-error' : ''}}">
                                        <input type="url" class="form-control" name="url" placeholder="Url" value="{{old('url', $item->url)}}" required>
                                        @if ($errors->has('url'))
                                    ...
                                    <div class="col-12 mb-3 {{ ($errors->has('about')) ? 'has-error' : ''}}">
                                        ...
                                        <textarea name="about"  class="form-control" placeholder="About Item" id="" cols="30" rows="10" maxlength="250">{{old('about', $item->about)}}</textarea>
                                        @if ($errors->has('about'))
                                    ...
                                    <div class="col-12 mb-3 {{ ($errors->has('path')) ? 'has-error' : ''}}">
                                        <input type="file" class="form-control" id="file" name="path" placeholder="Url">
                                        @if ($errors->has('path'))
